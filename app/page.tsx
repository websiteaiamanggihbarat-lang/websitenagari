  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-28 pb-36 px-6 lg:px-8 overflow-hidden">
        ...
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-blue-50/40 rounded-full blur-3xl"></div>
      ...
      <section id="profil" className="py-28 px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Pengertian Nagari */}
            <div className="group bg-gradient-to-br from-white to-gray-50 rounded-2xl p-8 border border-gray-200/50 hover:border-blue-200 hover:shadow-xl hover:shadow-blue-100/50 transition-all duration-300">
              <div className="flex items-center mb-6">
                <div className="w-12 h-12 bg-gradient-to-br from-blue-600 to-blue-700 rounded-xl flex items-center justify-center shadow-lg shadow-blue-500/20 mr-4 group-hover:scale-110 transition-transform">
            ...
            <div className="group bg-gradient-to-br from-white to-gray-50 rounded-2xl p-8 border border-gray-200/50 hover:border-blue-200 hover:shadow-xl hover:shadow-blue-100/50 transition-all duration-300">
              <div className="flex items-center mb-6">
                <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center shadow-lg shadow-blue-500/20 mr-4 group-hover:scale-110 transition-transform">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {/* Visi Misi Section */}
      <section id="visi-misi" className="py-28 px-6 lg:px-8 bg-gradient-to-b from-gray-50/50 to-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4 tracking-tight">
              Visi & Misi
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Visi */}
            <div className="group bg-white rounded-2xl p-10 border border-gray-200/50 shadow-xl hover:shadow-2xl hover:border-blue-200 transition-all duration-300 hover:scale-[1.02]">
            ...
            <div className="group bg-white rounded-2xl p-10 border border-gray-200/50 shadow-xl hover:shadow-2xl hover:border-blue-200 transition-all duration-300 hover:scale-[1.02]">
              ...
              <ul className="space-y-5">
                <li className="flex items-start group/item">
                  <div className="w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center mr-4 mt-0.5 flex-shrink-0 group-hover/item:bg-blue-200 transition-colors">
