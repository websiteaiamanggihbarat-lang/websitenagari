...
export default function Home() {
  return (
    <div className="min-h-screen bg-public-warm text-[#1F2937]">
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8 bg-white border-b border-[#E6DDCF]/50">
        <div className="relative max-w-6xl mx-auto scroll-slide-bottom">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Visi Pelayanan */}
            <div className="public-card-hover p-8 sm:p-10 flex flex-col justify-between">
              <div>
                <div className="flex items-center mb-6">
                  <div className="w-13 h-13 bg-gradient-to-br from-[#2C1B01] to-[#1A1200] rounded-2xl flex items-center justify-center shadow-md text-[#B6A587] mr-4 flex-shrink-0 border border-[#B6A587]/30">
            ...
            <div className="public-card-hover p-8 sm:p-10 flex flex-col justify-between">
              <div>
                ...
                <ol className="space-y-3.5 text-gray-700 text-base sm:text-lg">
      ...
      {/* Peta Section */}
      <section id="peta" className="py-24 px-4 sm:px-6 lg:px-8 bg-public-warm">
      ...
      <section id="profil" className="py-24 px-4 sm:px-6 lg:px-8 bg-white border-t border-[#E6DDCF]/50">
        <div className="max-w-6xl mx-auto space-y-16">
          ...
          <div className="public-card p-8 sm:p-12 scroll-slide-bottom">
            <div className="flex items-center mb-8">
              <div className="w-14 h-14 bg-gradient-to-br from-[#2C1B01] to-[#1A1200] rounded-2xl flex items-center justify-center shadow-md text-[#B6A587] mr-4 flex-shrink-0 border border-[#B6A587]/30">
                <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="text-gray-700 leading-relaxed space-y-5 text-base sm:text-lg text-justify">
              <p>
          ...
          {/* Visi & Misi Nagari */}
          <div>
            <div className="text-center mb-10 scroll-slide-left">
              <h3 className="text-2xl sm:text-3xl font-extrabold text-[#1F2937] tracking-tight">
                Visi &amp; Misi Nagari
              </h3>
              <div className="gonjong-line max-w-xs mx-auto mt-3"></div>
            ...
            <div className="space-y-8">
              {/* Visi */}
              <div className="public-card p-8 sm:p-10 scroll-slide-bottom">
                <div className="flex items-center justify-center mb-6">
                  ...
                  <h4 className="text-2xl font-extrabold text-[#1F2937] tracking-tight">
                    Visi
                  </h4>
                </div>

                <p className="text-lg leading-relaxed text-gray-800 text-center font-medium max-w-3xl mx-auto">
              ...
              <div className="public-card p-8 sm:p-10 scroll-slide-bottom">
                ...
                <ul className="space-y-4 text-justify">
                  <li className="flex items-start gap-4 group">
                    <div className="w-7 h-7 bg-[#F0E8DB] rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 border border-[#B6A587]/40 group-hover:bg-[#B6A587] transition-colors">
                      <span className="text-[#2C1B01] font-extrabold text-xs group-hover:text-white">1</span>
                    </div>
                    <span className="text-gray-700 leading-relaxed text-base pt-0.5">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Batas Wilayah */}
            <div className="public-card-hover p-8 scroll-slide-left">
              <div className="flex items-center mb-6">
                <div className="w-12 h-12 bg-gradient-to-br from-[#2C1B01] to-[#1A1200] rounded-xl flex items-center justify-center shadow-md text-[#B6A587] mr-4 flex-shrink-0 border border-[#B6A587]/30">
                ...
                <div>
                  <h3 className="text-xl font-extrabold text-[#1F2937] tracking-tight">
                    Batas-Batas Wilayah
                  </h3>
            ...
            {/* Jorong */}
            <div className="public-card-hover p-8 scroll-slide-right">
              <div className="flex items-center mb-6">
                <div className="w-12 h-12 bg-gradient-to-br from-[#2C1B01] to-[#1A1200] rounded-xl flex items-center justify-center shadow-md text-[#B6A587] mr-4 flex-shrink-0 border border-[#B6A587]/30">
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="text-gray-700 leading-relaxed space-y-4 text-justify text-sm sm:text-base">
                <p>
                ...
                <div className="space-y-3">
                  <div className="p-3.5 bg-[#F7F2E8] rounded-xl border border-[#E6DDCF]">
                    <p className="font-bold text-[#2C1B01] text-sm mb-1">
