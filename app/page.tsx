      ...
      <section className="relative h-screen min-h-[600px] px-6 lg:px-8 overflow-hidden flex items-center justify-center">
        ...
        <div className="absolute inset-0">
          <div
            ...
            style={{
              backgroundImage:
                "url('/image/keluarga-besar-nagari.jpeg')",
            }}
          ></div>
        ...
        <div className="relative max-w-5xl mx-auto text-center animate-fade-in z-10">
          ...
          <p className="text-base md:text-lg text-white/95 max-w-3xl mx-auto leading-relaxed drop-shadow-md">
            ...
            Kreatif, Bebas Biaya, Aman, Nyaman, dan
            Adil"
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="group bg-gradient-to-br from-white to-gray-50 rounded-2xl p-8 border border-gray-200/50 hover:border-[#c0ae86] hover:shadow-xl hover:shadow-[rgba(182,165,135,0.5)] transition-all duration-300 scroll-slide-right">
              ...
              <div className="text-gray-700 leading-relaxed space-y-4">
                <div>
                  <p className="mb-4">
                    Di Nagari Aia Manggih Barat terdapat
                ...
                <div className="pt-4 border-t border-gray-200">
                  <p className="mb-4">
                    Sedangkan keadaan Kesehatan lingkungan
                    ...
                    <table className="w-full text-sm border-collapse">
                      ...
                      <tbody className="text-gray-700">
                        <tr className="border-b border-gray-200">
                          <td className="px-3 py-2">1.</td>
                          <td className="px-3 py-2">
                            Rumah memiliki WC, dengan septic
                            tanah
                          </td>
                          <td className="px-3 py-2 text-center font-semibold">
                            12
                        ...
                        <tr className="border-b border-gray-200">
                          <td className="px-3 py-2">2.</td>
                          <td className="px-3 py-2">
                            Rumah memiliki WC, tanpa septic
                            tanah
                          </td>
                          <td className="px-3 py-2 text-center font-semibold">
                            81
                        ...
                        <tr>
                          <td className="px-3 py-2">3.</td>
                          <td className="px-3 py-2">
                            Rumah memanfaatkan aliran Sungai
                            untuk MCK
                          </td>
                          <td className="px-3 py-2 text-center font-semibold">
                            451
